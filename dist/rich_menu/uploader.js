...
var upload_action_vote_1 = require("./upload_action_vote");
...
var name = upload_action_vote_1.parcel.name, chatBarText = upload_action_vote_1.parcel.chatBarText, imagePath = upload_action_vote_1.parcel.imagePath, _a = upload_action_vote_1.parcel.richTemplate, templateWidth = _a.width, templateHeight = _a.height, 
// richGrid: { width, height },
actions = upload_action_vote_1.parcel.actions;
housekeeping
    .then(function () {
