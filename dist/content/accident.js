...
exports.fee = [
    'สิ่งที่ควรทำเมื่อเกิดอุบัติเหตุ แล้วจะไม่เสียเปรียบคู่กรณี กดลิ้ง',
    ...
    'พ.ร.บ.ค่าตอบแทนผู้เสียหายและค่าทดแทนและค่าใช้จ่ายของจำเลยในอคดีอาญา (อ่านต่อ) คลิกลิ้ง',
    'http://www.rlpd.go.th/rlpdnew/images/rlpd_6/Information/Information_2556/Other/1001.pdf'
];
exports.insurance = [
    'https://www.facebook.com/groups/LAW.DOME/permalink/2331100730299470?sfns=mo',
    'ขั้นตอนและวิธ๊เรียกร้องค่าสินไหมฯ คลิกลิ้ง',
    'https://www.dhipaya.co.th/insurance/insurance.asp?ID=32&idMenu=55',
    'โทรด่วน 1791 หรือติดต่อที่ http://www.rvp.co.th'
];
